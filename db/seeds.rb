...
ActiveRecord::Base.transaction do
  ...
  Item.create!(home_id: 1, category_id: 1, name: "chainsaw", description: "im a green chainsaw", main_photo_id: 6)
  Item.create!(home_id: 2, main_photo_id: 7, category_id: 1, name: "chain saw", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
  ...
  Item.create!(home_id: 2, main_photo_id: 11, category_id: 1, name: "lawn mower", description: "Im yellow. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
  ...
  Item.create!(home_id: 1, main_photo_id: 13, category_id: 1, name: "rake for leaves", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
  ...
  Item.create!(home_id: 1, main_photo_id: 16, category_id: 1, name: "riding lawnmower", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
  Item.create!(home_id: 1, main_photo_id: 17, category_id: 1, name: "pole saw", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
  ...
  Item.create!(home_id: 1, main_photo_id: 20, category_id: 1, name: "shovels", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
  ...
  Item.create!(home_id: 3, main_photo_id: 25, category_id: 1, name: "wheelbarrow", description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam maxime possimus aperiam.")
